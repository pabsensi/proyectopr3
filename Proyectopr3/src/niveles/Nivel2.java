...
public class Nivel2 {
	...
	public static int createLevel(Handler handler) {
		...
		for(int i=Juego.WIDTH/3;i< (int)(Juego.WIDTH*2)/3;i+=32){
			...
			handler.addObject(new Block(i+1200,Juego.HEIGHT-295,ObjectId.Block,"grass.png"));;
			handler.addObject(new Block(i+1000,Juego.HEIGHT-250,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+1600,Juego.HEIGHT-90,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+800,Juego.HEIGHT-205,ObjectId.Block,"grass.png"));
			...
			//izquierda//
			handler.addObject(new Block(i+1800, Juego.HEIGHT-160,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+2000, Juego.HEIGHT-210,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+2400, Juego.HEIGHT-130,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+2700, Juego.HEIGHT-110,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+2900, Juego.HEIGHT-140,ObjectId.Block,"grass.png"));
			handler.addObject(new Block(i+3100, Juego.HEIGHT-175,ObjectId.Block,"grass.png"));
